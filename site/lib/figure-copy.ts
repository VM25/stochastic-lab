...
export const FIGURE_COPY: Record<string, FigureCopy> = {
  "exp01_sampling_convergence.png": {
  ...
  "exp02_strong_convergence.png": {
    ...
    caption:
      "Strong error versus time step on common Brownian paths, one panel per parameter variation. Fitted orders and intervals are read from the record; error bars are the engine's standard errors.",
  },
  "exp02_local_orders.png": {
  ...
  "exp05_work_normalised_efficiency.png": {
  ...
  "exp06_space_convergence.png": {
    ...
    caption:
      "Spatial convergence: pricing error versus asset spacing ΔS, log-log, against a second-order reference. Fitted orders are read from the record.",
  },
  "exp06_time_convergence.png": {
  ...
  "exp07_pde_convergence.png": {
    ...
    caption:
      "The absorbing-boundary PDE arm converging to the analytic continuous-barrier price at order ~2, in both directions — a standing regression on the operator.",
  },
  "exp08_fd_variance_scaling.png": {
  ...
  "exp08_estimator_standard_error.png": {
  ...
  "exp09_cf_validation.png": {
    ...
    caption:
      "Left: quadrature convergence, an internal numerical check. Right: agreement with external references, kept in separate provenance categories rather than presented as independent oracles.",
  },
  "exp10_variance_discretization.png": {
  ...
  "exp12_parameter_dispersion.png": {
